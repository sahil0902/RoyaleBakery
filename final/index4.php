...
<body class="bg-black" >
    ...
    <div class="main-wrap" id="section-home">
        <div class="responsive-container" style="height: 325px;">
            <div class="img_logo dynamic-background" id="dynamic-bg" style="height: 400px;">
                <!-- Your content here -->
                <div class="container">
                    ...
                    <div class="ftco-38-body" style="height: 110px;">
                    <p class="introduction" style="font-size: 12px;">Welcome to Royale Bakery - where tradition meets taste.</p>
    <p class="address" itemscope itemtype="http://schema.org/PostalAddress" style="font-size: 10px;">
        Visit Us: <span itemprop="streetAddress">203 Otley Road</span>,
        <span itemprop="addressLocality" style="font-size: 10px;">Bradford</span>,
        <span itemprop="addressRegion" style="font-size: 10px;">BD3 0JF</span>
...
document.addEventListener('DOMContentLoaded', function() {
    var backgroundImages = ['images/paint.png','images/store2.png', 'images/cakes.png', 'images/shop.png', 'images/gulab.png'];
    var currentImage = 0;

    function changeBackgroundImage() {
        var bgElement = document.getElementById('dynamic-bg');
        bgElement.style.backgroundImage = 'url(' + backgroundImages[currentImage] + ')';

        // Set a default background position for all images
        bgElement.style.backgroundPosition = 'center center';

        // Change background size to 'contain' to ensure the full image is visible
