          ...
          <div class="banner-static">
            <div class="banner-text">
              <div class="banner-cell">
                ...
                <h2>Taste of Royality, at your fingertips</h2>
                <p>
                  Welcome to Royale Bakery! Our bakery is dedicated to
                  providing you with the freshest and most delicious baked
                  goods. From our signature croissants to our delectable cakes,
                  we use only the finest ingredients to ensure that every bite
                  is a treat for your taste buds. Come visit us today and
                  experience the magic of Royale Bakery!
                </p>
                <div class="book-btn">
                  <a
                    href="#reservation"
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            >
              ...
              <p>
This is dummy text and should be replaced with a proper translation.
              </p>

              <p>
                It all started quite simply. With a passion for baking and a
                desire to share our love of delicious treats with the world, we
                opened Royale Bakery. From our signature croissants to our
                delectable cakes, we use only the finest ingredients to ensure
                that every bite is a treat for your taste buds. Come visit us
                today and experience the magic of Royale Bakery!
              </p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <!-- Organize menu items by category -->
                  <!-- show the menu entered from menu.php under correct category right now its displaying in everuy catgegory if its drink it should only show when the user presses show_source-->
                <?php
                $organized_menu = [];
                foreach ($menu_items as $item) {
                    $organized_menu[$item['category']][] = $item;
                }

                foreach ($organized_menu as $category => $items) : ?>
                    <div class="category-section">
                        <h3 class="text-center"><?= htmlspecialchars($category); ?></h3>

                        <?php foreach ($items as $item) : ?>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="offer-item">
                                    <?php if (!empty($item['image_data'])): ?>
                                        <img src="data:image/jpeg;base64,<?= base64_encode($item['image_data']); ?>" alt="<?= htmlspecialchars($item['name']); ?>" class="img-responsive">
                                    <?php else: ?>
                                        <img src="path/to/default/image.jpg" alt="Default Image" class="img-responsive">
                                    <?php endif; ?>
                                    <div>
                                        <h3><?= htmlspecialchars($item['name']); ?></h3>
                                        <p><?= htmlspecialchars($item['description']); ?></p>
                                    </div>
                                    <span class="offer-price">£<?= htmlspecialchars($item['price']); ?></span>
                                </div>
                            </div>
                        <?php endforeach; ?>
        ...
        <!-- "Images Not Found" section remains unchanged -->
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                    <h2 class="block-title text-center">Images Not Found</h2>
                    <p class="title-caption text-center">
                        We are sorry, but the images you are looking for are not available at the moment. Please check back later.
                    </p>
                </div>
            </div>
        </div>
...
<div class="tab-menu">
    <!-- Tab titles remain unchanged -->
    <div class="slider slider-nav">
        <!-- ... -->
    </div>

    <!-- This is the content for each tab. Assuming you might need to adapt the organization of menu items per category here too. -->
    ...
    <div class="slider slider-single">
        ...
        <div class="menu-category">
            <?php foreach ($menu_items as $item) : ?>
                <?php if ($item['category'] == 'STARTERS') : ?>
                    <!-- Your existing menu item display code here... -->
                <?php endif; ?>
            <?php endforeach; ?>
        </div>
        ...
        <div class="menu-category">
            <?php foreach ($menu_items as $item) : ?>
                <?php if ($item['category'] == 'MAIN DISHES') : ?>
                    <!-- Your existing menu item display code here... -->
                <?php endif; ?>
            <?php endforeach; ?>
        </div>
...
<script>
    $(document).ready(function() {
        $('.tab-title-menu').on('click', function() {
            var index = $(this).index();
            
            // Hide all categories and show only the selected one
            $('.menu-category').hide();
            $('.menu-category').eq(index).show();
        });
    });
</script>
              ...
              >
                <div class="col-md-6 col-sm-6">
                  <div class="blog-block">
                    ...
                    <div class="blog-dit">
                      <p><span>12 NOVEMBER, 2023</span></p>
          ...
          <div class="panel-pricing-in">
            ...
            <div class="col-md-4 col-sm-4 text-center">
              <div class="panel panel-pricing">
                ...
                <div class="panel-body text-center">
                  <p>
                    <strong>$30/<span>Month</span></strong>
                  </p>
                </div>
                <ul class="list-group text-center">
                  <li class="list-group-item">
                    <i class="fa fa-check"></i> One Website
                  </li>
                  <li class="list-group-item">
                    <i class="fa fa-check"></i> One User
                  </li>
                  <li class="list-group-item">
                    <i class="fa fa-check"></i> 10 GB Bandwidth
                  </li>
                  <li class="list-group-item">
                    <i class="fa fa-times"></i> 2GB Storage
                  </li>
                  <li class="list-group-item">
                    <i class="fa fa-times"></i> Offline work
                  </li>
                  <li class="list-group-item">
                    <i class="fa fa-check"></i> 24x7 Support
                  </li>
                </ul>
                <div class="panel-footer">
                  <a
                    class="btn btn-lg btn-block hvr-underline-from-center"
                    href="#"
                    >Purchase Now!</a
                  >
                </div>
            ...
            <div class="col-md-4 col-sm-4 text-center">
              <div class="panel panel-pricing">
                ...
                <div class="panel-body text-center">
                  <p>
                    <strong>$60/<span>Month</span></strong>
                  </p>
                </div>
                <ul class="list-group text-center">
                  <li class="list-group-item">
                  ...
                  <li class="list-group-item">
                    <i class="fa fa-check"></i> 50 GB Bandwidth
                  </li>
                  <li class="list-group-item">
                    <i class="fa fa-check"></i> 2GB Storage
                  </li>
                  <li class="list-group-item">
                    <i class="fa fa-check"></i> Offline work
                  </li>
                  <li class="list-group-item">
                    <i class="fa fa-check"></i> 24x7 Support
                  </li>
            ...
            <div class="col-md-4 col-sm-4 text-center">
              <div class="panel panel-pricing">
                ...
                <div class="panel-body text-center">
                  <p>
                    <strong>$90/<span>Month</span></strong>
                  </p>
                </div>
                <ul class="list-group text-center">
                  <li class="list-group-item">
                  ...
                  <li class="list-group-item">
                    <i class="fa fa-check"></i> 100 GB Bandwidth
                  </li>
                  <li class="list-group-item">
                    <i class="fa fa-check"></i> 2GB Storage
                  </li>
              ...
              <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="footer-box-c">
                  ...
                  <p>
                    ...
                    <span><a href="#">abc@example.com</a></span>
                  </p>
                </div>
                <!-- end footer-box-c -->
              </div>
