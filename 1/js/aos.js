        ...
        var i = Object.assign || function(e) {
            ...
            z = function(e) {
                ...
                if (E(j.disable) || x) {
                    ...
                    // Event listeners
                    if ("DOMContentLoaded" === j.startEvent && ["complete", "interactive"].indexOf(document.readyState) > -1) {
                        O(!0);
                    } else if ("load" === j.startEvent) {
                    ...
                    // MutationObserver for DOMNodeRemoved replacement
                    var observer = new MutationObserver(function(mutations) {
                        mutations.forEach(function(mutation) {
                            if (mutation.removedNodes) {
                                mutation.removedNodes.forEach(function(node) {
                                    if (node.nodeType === 1 && node.hasAttribute && node.hasAttribute("data-aos")) {
                                        // Perform the actions that were previously in the DOMNodeRemoved event listener
                                    }
                                });
                            }
                        });
